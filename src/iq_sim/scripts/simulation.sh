...
gnome-terminal --tab -- bash -c "ros2 run iq_sim hub.py --ros-args -p n_drones:=$1 -p noise_dist_std:=0.0 "
echo 'hub launched!'
sleep $((30 * $1))
...
gnome-terminal --tab -- bash -c "ros2 run iq_sim main.py --ros-args -p n_drones:=$1 -p altitude:=0.0 -p noise_time_std:=0.0"
